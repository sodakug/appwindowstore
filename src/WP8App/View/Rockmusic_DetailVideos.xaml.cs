...
{
    /// <summary>
    /// Phone application page for Rockmusic_DetailVideos.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Rockmusic_DetailVideos : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Rockmusic_DetailVideos and all its components.
        /// </summary>
        public Rockmusic_DetailVideos()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaRockmusic_DetailVideos0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaRockmusic_DetailVideos0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaRockmusic_DetailVideos_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaRockmusic_DetailVideos(PanoramaRockmusic_DetailVideos.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaRockmusic_DetailVideos(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IRockmusic_OneMoreNight>();
				AddHomeAppBarButton();
				...
				((IViewModels.IRockmusic_DetailVideosViewModel)DataContext).CurrentYouTubeVideo = pinnedItem;				
			}
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.IRockmusic_VideosViewModel>(); 
