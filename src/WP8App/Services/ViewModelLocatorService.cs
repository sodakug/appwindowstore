...
namespace WPAppStudio.Services
{
    ...
    public class ViewModelLocatorService
    {
        ...
        /// <summary>
        /// Gets the reference to a Rockmusic_VideosViewModel.
        /// </summary>
		public IViewModels.IRockmusic_VideosViewModel Rockmusic_VideosViewModel
        {
            get { return _container.Resolve<IViewModels.IRockmusic_VideosViewModel>(); }
        }

        /// <summary>
        /// Gets the reference to a Rockmusic_DetailVideosViewModel.
        /// </summary>
		public IViewModels.IRockmusic_DetailVideosViewModel Rockmusic_DetailVideosViewModel
        {
            get { return _container.Resolve<IViewModels.IRockmusic_DetailVideosViewModel>(); }
        }
		/// <summary>
