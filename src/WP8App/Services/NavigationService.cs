...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IRockmusic_VideosViewModel), "/View/Rockmusic_Videos.xaml" },
            { typeof(IViewModels.IRockmusic_DetailVideosViewModel), "/View/Rockmusic_DetailVideos.xaml" },
