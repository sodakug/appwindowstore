...
namespace WPAppStudio.Repositories
{
    ...
    public class Rockmusic_OneMoreNight : IRockmusic_OneMoreNight 
    {
		...
		private const string YoutubeBaseUrl = "https://gdata.youtube.com/feeds/api/users/{0}/uploads?start-index={1}&max-results={2}&v=2";
		private const string YoutubeQuery = @"Maroon5VEVO";

        /// <summary>
        /// Initializes a new instance of the <see cref="Rockmusic_OneMoreNight" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Rockmusic_OneMoreNight(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: Maroon5VEVO ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: Maroon5VEVO ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: Maroon5VEVO ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        {
			var data = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Rockmusic_OneMoreNight");
        ...
        {
			var storedItems = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Rockmusic_OneMoreNight");
            ...
            {
				var newItems = await _youtubeDataSource.LoadRemote<IEnumerable<EntitiesBase.YouTubeVideo>>(String.Format(YoutubeBaseUrl, HttpUtility.UrlEncode(YoutubeQuery), pageNumber * MaxResults + 1, MaxResults));
                ...
                if(newItems != null && newItems.Any())
				{
					...
					_storageService.Save("Rockmusic_OneMoreNight", new ObservableCollection<EntitiesBase.YouTubeVideo>(storedCollection));
				}
			}
